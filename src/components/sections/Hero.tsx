  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          <div className="px-6 py-2 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-amber-500 text-sm font-semibold tracking-wider">
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="group p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-amber-500/30 transition-all duration-300"
            >
